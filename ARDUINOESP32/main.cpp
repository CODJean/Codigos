...
#define AUTHOR_EMAIL "jjrr182007@gmail.com"
#define AUTHOR_PASSWORD "seyr thhf wtjx joil"

/* Correo electrÃ³nico del recipiente*/
#define RECIPIENT_EMAIL "steel3950@gmail.com"
...
void setup() {
  ...
  */
  ...
  message.sender.name = "JESUCRISTO";
  message.sender.email = AUTHOR_EMAIL;
  message.subject = "Correo de SALVACI\Ó N";
  message.addRecipient("Ingeniero", RECIPIENT_EMAIL);

  //Manda texto
  String textMsg = "Hola Mundo. - Estamos superando la CARRERA a base de puntos extras :DD \n\" Gracias Profe\"\n";
